...
void FilePrinter::writeMainFile() {
    this->printHeader(*parameters->getMainWriter());
...
void FilePrinter::writeLastGenerationFile() {
    this->printHeader(*parameters->getLastGenerationWriter());
...
void FilePrinter::printHeader(std::ofstream &outputStream) {
